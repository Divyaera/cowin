...
def generate_token_OTP(mobile, request_header, bucket_str=None):
    """
    This function generate OTP and returns a new token or None when not able to get token
    """
    
    if bucket_str:
        storage_url = "https://kvdb.io/" + bucket_str + "/" + mobile
    else:
        storage_url = "https://kvdb.io/L7Zydftrax1mxDtMvgFAbk/" + mobile
